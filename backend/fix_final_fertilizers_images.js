...
const plantFixes = JSON.parse(fs.readFileSync('e:\\major_projet\\backend\\fertilizers_nutrients_images.json', 'utf8'));
...
async function fixImages() {
    try {
        ...
        console.log('Done fixing the Fertilizers & Nutrients category images!');
        process.exit(0);
    } catch (err) {
