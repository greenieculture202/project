...
const plantFixes = JSON.parse(fs.readFileSync('e:\\major_projet\\backend\\gardening_tools_images.json', 'utf8'));
...
async function fixImages() {
    try {
        ...
        console.log('Done fixing the Gardening Tools & Garden Toolkits category images!');
        process.exit(0);
    } catch (err) {
