...
const plantFixes = JSON.parse(fs.readFileSync('e:\\major_projet\\backend\\indoor_outdoor_images.json', 'utf8'));
...
async function fixImages() {
    try {
        ...
        console.log('Done fixing all indoor/outdoor plant images!');
        process.exit(0);
    } catch (err) {
