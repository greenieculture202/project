...
const plantFixes = JSON.parse(fs.readFileSync('e:\\major_projet\\backend\\remaining_categories_images.json', 'utf8'));
...
async function fixImages() {
    try {
        ...
        console.log('Done fixing every single remaining product image!');
        process.exit(0);
    } catch (err) {
