...
let FaqAllComponent = class FaqAllComponent {
    constructor() {
        this.openKey = signal(null);
        this.activeCategory = signal('All');
        this.categories = ['All', 'Orders', 'Payment', 'Delivery', 'Plants', 'Returns', 'Account'];
        this.categoryGroups = [
            {
                name: 'Orders',
...
export { FaqAllComponent };
//# sourceMappingURL=faq-all.js.map