...
let ReviewService = class ReviewService {
    constructor() {
        this.reviewsSignal = signal(this.loadReviews());
    }
    get reviews() {
        ...
        fetch('http://localhost:5000/api/reviews')
            ...
            if (localStr) {
                try {
                    ...
                    const newLocalReviews = actualLocalReviews.filter(localRev => !dbReviews.some((dbRev) => dbRev.description === localRev.description && dbRev.rating === localRev.rating));
