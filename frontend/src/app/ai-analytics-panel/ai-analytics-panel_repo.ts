        ...
        <div *ngIf="!isLoading" class="dashboard-grid">
          ...
          <div class="stat-card primary">
            ...
            <div class="stat-content">
              ...
              <span class="stat-trend up">Γåæ 8.4% <small>vs last month</small></span>
            </div>
          </div>
          ...
          <div class="stat-card success">
            ...
            <div class="stat-content">
              ...
              <span class="stat-trend up">Γåæ 12% <small>vs last month</small></span>
            </div>
          </div>
          ...
          <div class="stat-card warning">
            ...
            <div class="stat-content">
              ...
              <span class="stat-trend down">Γåô 2h <small>optimization</small></span>
            </div>
          </div>
