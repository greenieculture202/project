...
export class UserService {
    ...
    updateOrderStatus(orderId: string, status: string, extraData: any = {}): Observable<any> {
        return this.http.put(`/api/admin/orders/${orderId}/status`, { status, ...extraData }, { headers: this.getHeaders() });
    }
